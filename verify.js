// requires each field to be designated by matrix like indices (i,j) - example fields below
...
// in a real game scenario each possible combination of triples
// must be compared (in case 4 fields were selected before the win)
...
for (let a = 0; a < 9; a++) {
  for (let b = a+1; b < 9; b++) {
    for (let c = b+1; c < 9; c++) {
      ...
      // check all different orders as well
      /*
